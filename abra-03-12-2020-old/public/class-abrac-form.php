...
class ABRAC_Front_Form_Shortcode {
    ...
    public function __construct() {
       ...
       // add_action( 'init', array( $this, 'moonpay_insert_update_redirect_callback_from_main_form' ) );
        add_shortcode( 'abrac_conversion_form', array( $this, 'display_front_form_callback' ) );
    }
    ...
    public function moonpay_insert_update_callback_from_listing_page(){
        if(isset($_GET['externalTransactionId']) && wp_verify_nonce($_GET['abrac_buy_now'], 'abrac-buy-now')) {
               global $table_prefix, $wpdb;
                ...
                if($provider_name == "transak"){
                    ...
                    $data = array(
                        ...
                        'redirectURL'               => get_the_permalink(ABRAC_REDIRECT_URL),
                        //'hostURL'                   => get_the_permalink(ABRAC_REDIRECT_URL)
                    );
                    ...
                    exit();
                    /*
                    https://staging-global.transak.com/?apiKey=ae882203-9b59-4206-a48f-1bedcc22c753&hostURL=http://abra.demansol.tech/&defaultCryptoCurrency=ETH&defaultFiatAmount=500&fiatCurrency=USD
                    */
    ...
    public function display_front_form_callback($atts) {
    	...
    	ob_start();
	        $layout_path    = ABRAC_PLUGIN_PATH . 'templates/front-form.php';
	        require_once apply_filters( 'abrac_template_path', $layout_path );
        return ob_get_clean();
    }

}

$abrac_front_form = new ABRAC_Front_Form_Shortcode;