...
class TRANSAK_Enqueue_Scripts {
    ...
    public function public_enqueue_scripts() {
        ...
        wp_enqueue_script( 'transak-public-script', TRANSAK_PLUGIN_URL . '/assets/js/transak-public-script.js', array('jquery'), TRANSAK_PLUGIN_VER );
       ...
       wp_enqueue_style( 'transak-public-style', TRANSAK_PLUGIN_URL . 'assets/css/transak-public-style.css', array(), TRANSAK_PLUGIN_VER );
