<?php
/**
   https://github.com/ciaranmahoney/php/blob/master/insightly.php
...
class Insightly{
  ...
  public function getContacts($options = null){
    ...
    $request = $this->GET("/v3.1/Contacts");
  ...
  public function getContact($id){
    return $this->GET("/v3.1/Contacts/" . $id)->asJSON();
  }
  ...
  public function deleteContact($id){
    $this->DELETE("/v3.1/Contacts/$id")->asString();
    return true;
  }

  public function getContactEmails($contact_id){
    return $this->GET("/v3.1/Contacts/$contact_id/Emails")->asJSON();
  }

  public function getContactNotes($contact_id){
    return $this->GET("/v3.1/Contacts/$contact_id/Notes")->asJSON();
  }

  public function getContactTasks($contact_id){
    return $this->GET("/v3.1/Contacts/$contact_id/Tasks")->asJSON();
  }

  public function getCountries(){
    return $this->GET("/v3.1/Countries")->asJSON();
  }

  public function getCurrencies(){
    return $this->GET("/v3.1/Currencies")->asJSON();
  }

  public function getCustomFields(){
    return $this->GET("/v3.1/CustomFields")->asJSON();
  }

  public function getCustomField($id){
    return $this->GET("/v3.1/CustomFields/$id")->asJSON();
  }

  public function getEmails($options = null){
    $request = $this->GET("/v3.1/Emails");
    $this->buildODataQuery($request, $options);
    return $request->asJSON();
  }

  public function getEmail($id){
    return $this->GET("/v3.1/Emails/$id")->asJSON();
  }

  public function deleteEmail($id){
    $this->DELETE("/v3.1/Emails/$id")->asString();
    return true;
  }

  public function getEmailComments($email_id){
    $this->GET("/v3.1/Emails/$email_id/Comments")->asJSON();
  }
  ...
  public function addCommentToEmail($email_id, $body, $owner_user_id){
    ...
    return $this->POST("/v3.1/Emails/")->body($data)->asJSON();
  }

  public function getEvents($options = null){
    $request = $this->GET("/v3.1/Events");
    $this->buildODataQuery($request, $options);
    return $request->asJSON();
  }

  public function getEvent($id){
    return $this->GET("/v3.1/Events/$id")->asJSON();
  }
  ...
  public function deleteEvent($id){
    $this->DELETE("/v3.1/Events/$id")->asString();
    return true;
  }

  public function getFileCategories(){
    return $this->GET("/v3.1/FileCategories")->asJSON();
  }

  public function getFileCategory($id){
    return $this->GET("/v3.1/FileCategories/$id")->asJSON();
  }
  ...
  public function deleteFileCategory($id){
    $this->DELETE("/v3.1/FileCategories/$id")->asString();
    return true;
  }

  public function getNotes($options = null){
    $request = $this->GET("/v3.1/Notes");
    $this->buildODataQuery($request, $options);
    return $request->asJSON();
  }

  public function getNote($id){
    return $request = $this->GET("/v3.1/Notes/$id")->asJSON();
  }
  ...
  public function getNoteComments($note_id){
    return $this->GET("/v3.1/Notes/$note_id/Comments")->asJSON();
  }
  ...
  public function addNoteComment($note_id, $comment){
    ...
    return $this->POST("/v3.1/$note_id/Comments")->body($comment)->asJSON();
  }

  public function deleteNote($id){
    $this->DELETE("/v3.1/Notes/$id")->asString();
    return true;
  }

  public function getOpportunities($options = null){
    $request = $this->GET("/v3.1/Opportunities");
    $this->buildODataQuery($request, $options);
    return $request->asJSON();
  }
  
   public function getOpportunity($id){
    return $this->GET("/v3.1/Opportunities/" . $id)->asJSON();
  }
  ...
  public function deleteOpportunity($id){
    $this->DELETE("/v3.1/Opportunities/$id")->asString();
    return true;
  }

  public function getOpportunityEmails($opportunity_id){
    return $this->GET("/v3.1/Opportunities/$opportunity_id/Emails")->asJSON();
  }

  public function getOpportunityNotes($opportunity_id){
    return $this->GET("/v3.1/Opportunities/$opportunity_id/Notes")->asJSON();
  }

  public function getOpportunityStateHistory($opportunity_id){
    return $this->GET("/v3.1/Opportunities/$opportunity_id/StateHistory")->asJSON();
  }

  public function getOpportunityTasks($opportunity_id){
    return $this->GET("/v3.1/Opportunities/$opportunity_id/Tasks")->asJSON();
  }

  public function getOpportunityCategories(){
    return $this->GET("/v3.1/OpportunityCategories")->asJSON();
  }

  public function getOpportunityCategory($id){
    return $this->GET("/v3.1/OpportunityCategories/$id")->asJSON();
  }
  ...
  public function addOpportunityCategory($category){
    ...
    $url_path = "/v3.1/OpportunityCategories";
  ...
  public function deleteOpportunityCategory($id){
    $this->DELETE("/v3.1/OpportunityCategories/$id")->asString();
    return true;
  }

  public function getOpportunityStateReasons(){
    return $this->GET("/v3.1/OpportunityStateReasons")->asJSON();
  }

  public function getOrganizations($options = null){
    $request = $this->GET("/v3.1/Organisations");
    $this->buildODataQuery($request, $options);
    return $request->asJSON();
  }

  public function getOrganization($id){
    return $this->GET("/v3.1/Organizations/$id")->asJSON();
  }
  ...
  public function deleteOrganization($id){
    $this->DELETE("/v3.1/Organisations/$id")->asString();
    return true;
  }

  public function getOrganizationEmails($organization_id){
    return $this->GET("/v3.1/Organisations/$organization_id/Emails")->asJSON();
  }

  public function getOrganizationNotes($organization_id){
    return $this->GET("/v3.1/Organisations/$organization_id/Notes")->asJSON();
  }

  public function getOrganizationTasks($organization_id){
    return $this->GET("/v3.1/Organisations/$organization_id/Tasks")->asJSON();
  }

  public function getPipelines(){
    return $this->GET("/v3.1/Pipelines")->asJSON();
  }

  public function getPipeline($id){
    return $this->GET("/v3.1/Pipelines/$id")->asJSON();
  }

  public function getPipelineStages(){
    return $this->GET("/v3.1/PipelineStages")->asJSON();
  }

  public function getPipelineStage($id){
    return $this->GET("/v3.1/PipelineStages/$id")->asJSON();
  }

  public function getProjectCategories(){
    return $this->GET("/v3.1/ProjectCategories")->asJSON();
  }

  public function getProjectCategory($id){
    return $this->GET("/v3.1/ProjectCategories/$id")->asJSON();
  }
  ...
  public function addProjectCategory($category){
    ...
    $url_path = "/v3.1/ProjectCategories";
    if(isset($category->CATEGORY_ID) && ($category->CATEGORY_ID > 0)){
      $request = $this->PUT($url_path);
    }
    else{
  ...
  public function deleteProjectCategory($id){
    $this->DELETE("/v3.1/ProjectCategories/$id")->asString();
    return true;
  }

  public function getProjects($options = null){
    return $this->GET("/v3.1/Projects")->asJSON();
  }

  public function getProject($id){
    return $this->GET("/v3.1/Projects/$id")->asJSON();
  }
  ...
  public function deleteProject($id){
    $this->DELETE("/v3.1/Projects/$id")->asString();
    return true;
  }

  public function getProjectEmails($project_id){
    return $this->GET("/v3.1/Projects/$project_id/Emails")->asJSON();
  }

  public function getProjectNotes($project_id){
    return $this->GET("/v3.1/Projects/$project_id/Notes")->asJSON();
  }

  public function getProjectTasks($project_id){
    return $this->GET("/v3.1/Projects/$project_id/Tasks")->asJSON();
  }

  public function getRelationships(){
    return $this->GET("/v3.1/Relationships")->asJSON();
  }

  public function getTags($id){
    return $this->GET("/v3.1/Tags/$id")->asJSON();
  }

  public function getTasks($options = null){
    $request = $this->GET("/v3.1/Tasks");
    $this->buildODataQuery($request, $options);
  ...
  public function getTask($id){
    return $this->GET("/v3.1/Tasks/$id")->asJSON();
  }
  ...
  public function deleteTask($id){
    $this->DELETE("/v3.1/Tasks/$id")->asString();
    return true;
  }

  public function getTaskComments($task_id){
    return $this->GET("/v3.1/Tasks/$task_id/Comments")->asJSON();
  }

  public function addTaskComment($task_id, $comment){
    return $this->POST("/v3.1/Tasks/$task_id/Comments")->body($comment)->asJSON();
  }

  public function getTeams($options = null){
    $request = $this->GET("/v3.1/Teams");
    $this->buildODataQuery($request, $options);
    return $request->asJSON();
  }

  public function getTeam($id){
    return $this->GET("/v3.1/Teams/$id")->asJSON();
  }
  ...
  public function deleteTeam($id){
    $this->DELETE("/v3.1/Teams/$id")->asString();
    return true;
  }

  public function getTeamMembers($team_id){
    return $this->POST("/v3.1/TeamMembers/teamid=$team_id")->asJSON();
  }

  public function getTeamMember($id){
    return $this->POST("/v3.1/TeamMembers/$id")->asJSON();
  }
  ...
  public function addTeamMember($team_member){
    ...
    return $this->POST("/v3.1/TeamMembers")->body($team_member)->asJSON();
  }

  public function updateTeamMember($team_member){
    return $this->PUT("/v3.1/TeamMembers")->body($team_member)->asJSON();
  }

  public function deleteTeamMember($id){
    $this->DELETE("/v3.1/TeamMembers/$id")->asString();
    return true;
  }

  public function getUsers(){
    return $this->GET("/v3.1/Users")->asJSON();
  }

  public function getUser($id){
    return $this->GET("/v3.1/Users/" . $id)->asJSON();
  }
...
class InsightlyRequest{
  const URL_BASE = 'https://api.insightly.com';
  private $curl;
  private $url_path;
  private $headers;
